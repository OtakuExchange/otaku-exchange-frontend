...
function DesktopSubtopicNav({
  ...
  return (
    <Box sx={{ display: { xs: "none", md: "block" }, width: 220, flexShrink: 0, pt: 2, ml: "10px" }}>
...
export default function SubtopicNav({
  ...
  return (
    <>
      <MobileSubtopicNav subtopics={subtopics} selected={selected} onSelect={onSelect} />
      <DesktopSubtopicNav subtopics={subtopics} selected={selected} onSelect={onSelect} />
    </>
  );
}
