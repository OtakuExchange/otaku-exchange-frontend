...
function PortfolioRows({
  ...
  function renderRow(
    { pool, opponents, totalVolume }: (typeof rows)[0],
    clickable: boolean,
  ) {
    ...
    return (
      <Stack
        ...
        alignItems="center"
        onClick={
          clickable ? () => navigate(`/events/${pool.eventId}`) : undefined
        }
      ...
      >
        <Stack
          ...
          alignItems="center"
          spacing={1}
          sx={{ width: "15%", flexShrink: 0, minWidth: 0 }}
        >
            ...
            {pool.isWinner ? (
              ...
              <>
                ...
                <Typography
                  ...
                  sx={{ color: "#3DB468" }}
                >
                  {(payout / 100).toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD",
                  })}
                </Typography>
